<template>
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
        ...
        >
            <!-- Logo Section -->
            <div
                class="h-20 flex items-center justify-between px-6 border-b border-white/10 bg-gradient-to-r from-indigo-900 to-indigo-800"
            >
                <div class="flex items-center gap-3">
                    ...
                    <div v-else class="flex items-center gap-3">
                        <div
                            class="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center shadow-lg"
                        >
                            <svg
            ...
            <!-- User Profile Footer -->
            <div
                class="absolute bottom-0 left-0 right-0 p-4 border-t border-white/10 bg-gradient-to-r from-indigo-950 to-indigo-900"
            >
                <div
                    class="flex items-center gap-3 p-3 rounded-xl bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all cursor-pointer"
                >
                    <div class="relative">
                        <div
                        ...
                        <div
                            class="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-green-400 border-2 border-indigo-900 rounded-full"
                        ></div>
                    </div>
        ...
        <div class="lg:pl-72 min-h-screen">
            <!-- Top Bar -->
            <header
                class="sticky top-0 z-30 h-20 bg-white/80 backdrop-blur-xl shadow-sm border-b border-gray-200/50"
            >
