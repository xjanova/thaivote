                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    <div class="glass-card p-5">
                        ...
                        <div class="grid grid-cols-2 gap-x-4 gap-y-1.5 mt-4">
                            <div
                                v-for="r in sortedResults.slice(0, 8)"
                                :key="r.party_id"
                            ...
                            >
                                ...
                                <span class="text-[10px] font-bold text-white/80 ml-auto">{{
                                    r.total_seats
                                }}</span>
                            </div>
                        </div>
            ...
            <div v-if="activeTab === 'constituency'" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="glass-card p-5">
                        ...
                        <div class="h-[280px]">
                            <VoteBarChart
                                :results="constituencySorted"
                                :max-items="10"
                                value-key="constituency_votes"
                                label-suffix="คะแนน"
                            />
                        </div>
                    </div>
                    <div class="glass-card p-5">
                        ...
                        <div class="h-[280px]">
                            <VoteBarChart
                                :results="constituencySorted"
                                :max-items="10"
                                value-key="constituency_seats"
                                label-suffix="ที่นั่ง"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div v-if="activeTab === 'partylist'" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="glass-card p-5">
                        ...
                        <div class="h-[280px]">
                            <VoteBarChart
                                :results="partyListSorted"
                                :max-items="10"
                                value-key="party_list_votes"
                                label-suffix="คะแนน"
                            />
                        </div>
                    </div>
