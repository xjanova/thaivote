    ...
    <AdminLayout>
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">เพิ่มพรรคการเมืองใหม่</h1>
                    <p class="text-gray-600">กรอกข้อมูลพรรคการเมือง</p>
                </div>
            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="อธิบายเกี่ยวกับพรรค นโยบาย จุดยืน..."
                            ></textarea>
                        </div>
                    </div>
                </div>
...
const submit = () => {
    form.post(route('admin.parties.store'), {
        forceFormData: true,
    });
};
</script>
