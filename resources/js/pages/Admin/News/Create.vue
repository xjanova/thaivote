    ...
    <AdminLayout>
        <div class="max-w-3xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">เพิ่มข่าวใหม่</h1>
                    <p class="text-gray-600">กรอกข้อมูลข่าวที่ต้องการเพิ่ม</p>
                </div>
            </div>
            ...
            <form class="bg-white rounded-lg shadow p-6 space-y-6" @submit.prevent="submit">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                :class="{ 'border-red-500': form.errors.news_source_id }"
                            >
                            ...
                            <p v-if="form.errors.news_source_id" class="mt-1 text-sm text-red-500">
                                {{ form.errors.news_source_id }}
                            </p>
                        </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex flex-wrap gap-6">
                        <div class="flex items-center gap-2">
                            ...
                            />
                            <label for="is_approved" class="text-sm text-gray-700"
                                >เผยแพร่ทันที</label
                            >
                        </div>
                ...
                <div class="flex justify-end gap-3 pt-4 border-t">
                    ...
                    >
                        {{ form.processing ? 'กำลังบันทึก...' : 'สร้างข่าว' }}
                    </button>
                </div>
            </form>
        </div>
