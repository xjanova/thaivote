    ...
    <AdminLayout>
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h1 class="text-2xl font-bold text-gray-900">แก้ไข {{ source.name }}</h1>
                    <p class="text-gray-600">แก้ไขข้อมูลแหล่งข่าว</p>
                </div>
            </div>
...
const form = useForm({
    ...
    name_th: props.source.name_th || '',
    website: props.source.website || '',
    logo: props.source.logo || '',
    rss_url: props.source.rss_url || '',
    api_endpoint: props.source.api_endpoint || '',
    scrape_config: props.source.scrape_config,
...
const scrapeConfigText = ref(
    props.source.scrape_config ? JSON.stringify(props.source.scrape_config, null, 2) : ''
);
